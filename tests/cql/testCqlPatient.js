...
chai.should()
import { Patient, Code, DateTime, Interval } from '../../src/cql'
...
describe('Record', function () {
  ...
  it('should get codes', function () {
    this.encRecord.getCode('class').should.eql(new Code('185349003', '2.16.840.1.113883.6.96', '2013-09'))
    this.encRecord.getCode('type').should.eql(new Code('G0438', '2.16.840.1.113883.6.285', '2014'))
    return this.cndRecord.getCode('code').should.eql(new Code('1532007', '2.16.840.1.113883.6.96', '2013-09'))
  })

  it('should get dates', function () {
    this.cndRecord.getDate('onsetDateTime').should.eql(DateTime.parse('1982-03-12'))
    this.cndRecord.getDate('abatementDateTime').should.eql(DateTime.parse('1982-03-26'))
    return this.cndRecord.getDate('issued').should.eql(DateTime.parse('1982-03-15T15:15:00'))
  })

  it('should get intervals', function () {
    return this.encRecord.getInterval('period').should.eql(new Interval(DateTime.parse('1978-07-15T10:00'), DateTime.parse('1978-07-15T10:45')))
  })

  return it('should get date or interval', function () {
    this.cndRecord.getDateOrInterval('issued').should.eql(DateTime.parse('1982-03-15T15:15:00'))
    return this.encRecord.getDateOrInterval('period').should.eql(new Interval(DateTime.parse('1978-07-15T10:00'), DateTime.parse('1978-07-15T10:45')))
  })
})
...
describe('Patient', function () {
  ...
  it('should contain patient attributes', function () {
    ...
    return this.patient.birthDate.should.eql(DateTime.parse('1974-07-12T11:15'))
  })
